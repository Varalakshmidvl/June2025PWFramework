...
pipeline {
    ...
    environment {
        ...
        SLACK_WEBHOOK_URL = credentials('slack-webhook-token')
        // Email recipients - update these with your actual email addresses
        EMAIL_RECIPIENTS = 'varalakshmi.d@gmail.com, varalakshmi.doddi@gmail.com'
    }
            ...
            <table class="status-table">
                ...
                <tr>
                    ...
                    <td><a href="${env.BUILD_URL}PROD_20HTML_20Report">View</a></td>
                        ...
                        mimeType: 'text/html',
                        to: env.EMAIL_RECIPIENTS,
                        from: 'CI Notifications <varalakshmiautomation@gmail.com>',
                        replyTo: 'varalakshmi.d@gmail.com'
                    )
                } catch (Exception e) {
                    echo "Email notification failed: ${e.message}"
                }
            ...
            <table class="status-table">
                ...
                <tr>
                    ...
                    <td><a href="${env.BUILD_URL}PROD_20HTML_20Report">View</a></td>
                        ...
                        mimeType: 'text/html',
                        to: env.EMAIL_RECIPIENTS,
                        from: 'CI Notifications <varalakshmi.d@gmail.com>',
                        replyTo: 'varalakshmiautomation@gmail.com'
                    )
                } catch (Exception e) {
                    echo "Email notification failed: ${e.message}"
                }
...
>>>>>>> d13ab07 (Jenkins file for cicd updateone)
